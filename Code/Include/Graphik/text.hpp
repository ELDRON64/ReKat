...
public: 
    ...
    int make ( std::string font ) {
        ...
        { return ReKat::grapik::FAILED_INIT_FREETYPE; }

        // find path to font
        if ( font.empty ( ) ) { return ReKat::grapik::FAILED_LOAD_FONT; }
        
        // load font as face
        FT_Face face;
        if ( FT_New_Face ( ft, font.c_str(), 0, &face ) ) { return ReKat::grapik::FAILED_LOAD_FONT; }
        else {
