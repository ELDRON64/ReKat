...
int main()
{
    ReKat::grapik::Start ( "cok departement ", 800, 600 );

    // build and compile our shader zprogram
    // ------------------------------------
    ReKat::grapik::Resource_Manager::Load_Shader ( "texture","Shaders/texture.vs","Shaders/texture.fs" );
    ...
    unsigned char *data = stbi_load( "Eldron.png", &width, &height, &nrChannels, 0);
    if (data)
    {
    ...
    while ( ReKat::grapik::IsEnd() )
    {
        ...
        // render container
        ReKat::grapik::Resource_Manager::Get_Shader ("texture");
        glBindVertexArray(VAO);
